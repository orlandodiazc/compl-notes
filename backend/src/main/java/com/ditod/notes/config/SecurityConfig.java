...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http.authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.OPTIONS, "/**")
                ...
                .access(new WebExpressionAuthorizationManager("hasAuthority('CREATE:NOTE:ANY') or (hasAuthority('CREATE:NOTE:OWN') and #username == authentication.name)"))
                .requestMatchers(HttpMethod.PUT, "/users/{username}/notes/**")
                .access(new WebExpressionAuthorizationManager("hasAuthority('UPDATE:NOTE:ANY') or (hasAuthority('UPDATE:NOTE:OWN') and #username == authentication.name)"))
                .requestMatchers(HttpMethod.DELETE, "/users/{username}/notes/**")
                .access(new WebExpressionAuthorizationManager("hasAuthority('DELETE:NOTE:ANY') or (hasAuthority('DELETE:NOTE:OWN') and #username == authentication.name)"))
