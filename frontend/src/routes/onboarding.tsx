...
import { useOnboardingMutation } from "@/lib/api/mutations";
import { onboardingEmailQuery } from "@/lib/api/queryOptions";
...
export const Route = createFileRoute("/onboarding")({
  ...
  loader: ({ context: { queryClient } }) => {
    return queryClient.ensureQueryData(onboardingEmailQuery);
  },
});
...
export default function SignupRoute() {
  const { data } = useSuspenseQuery(onboardingEmailQuery);
